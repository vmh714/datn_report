...
Chương 4 trình bày quá trình thực nghiệm, các thông số đánh giá và kết quả đạt được của mô hình học máy cũng như toàn bộ hệ thống khi hoạt động thực tế.

Chương 5 mô tả chi tiết giải pháp đóng góp của đồ án, bao gồm kiến trúc hệ thống, thiết kế cơ sở dữ liệu và các thành phần phần cứng, phần mềm đã được hiện thực hóa.
